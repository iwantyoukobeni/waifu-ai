...
async def option1(ctx, length: int):
    ...
    Example Usage:
    ",option1 8"
    This command will continuously generate usernames of length 8 consisting of only ASCII lowercase letters until stopped manually.
    """
...
async def option2(ctx, length: int):
    ...
    Example Usage:
    ",option2 6"
    This command will continuously generate usernames of length 6 consisting of only digits until stopped manually.
    """
...
async def option3(ctx, length: int):
    ...
    Example Usage:
    ",option3 8"
    This command will continuously generate usernames of length 8 consisting of ASCII lowercase letters and digits until stopped manually.
    """
